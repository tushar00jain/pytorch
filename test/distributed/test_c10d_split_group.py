...
class SplitGroupBackendWrapperTest(SplitGroupTestBase):
    ...
    def test_split_group_single_backend(self):
        """Test split_group with single ncclx backend via BackendWrapper on default pg."""
        device = self._init_pg("cuda:ncclx")
    ...
    def test_split_group_multi_backend(self):
        """Test split_group with cpu:gloo,cuda:ncclx splits both backends via BackendWrapper on default pg."""
        device = self._init_pg("cpu:gloo,cuda:ncclx")
