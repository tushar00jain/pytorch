...
def _new_group_via_split_group(
    ...
    # torchcomms backends require the current rank to be a member of the split
    # passed to `parent_pg.split_group`, so short-circuit non-members here
    # instead of relying on the C++ backend to recognize and skip them.
